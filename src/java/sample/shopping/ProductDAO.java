...
public class ProductDAO {
    ...
    private static String SEARCH = "SELECT *FROM [TechShopAssignmnet].[dbo].[Product] where [name] like ?";

    public ArrayList<Product> searchProduct(String search) {
        ArrayList<Product> list = new ArrayList<>();
        String sql = "SELECT *FROM [TechShopAssignmnet].[dbo].[Product] where [name] like ?";
...
//          System.out.println(d.getProduct("", "tn", 1, ""));
 System.out.println(d.searchProduct("tn"));
    }
